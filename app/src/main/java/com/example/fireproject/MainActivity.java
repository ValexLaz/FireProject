...
import com.example.fireproject.models.Coordinate;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void openWhatsApp(String phoneNumber, double latitude, double longitude) {
        String msg = "A fire has been reported at this location. ";
        String mapUrl = msg + "https://www.google.com/maps/place/" + latitude + "," + longitude + " HELP NEEDED";
